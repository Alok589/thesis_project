...
class new_model(nn.Module):
    def __init__(self):
        ...
        self.up_conv1 = conv_transpose(128, 64)
        self.conv_bn1 = conv_bn(128, 64)
        self.residual_5 = residual_block(64, 64)
        self.senet_5 = SELayer(64, 64)

        self.up_conv2 = conv_transpose(64, 32)
        self.conv_bn2 = conv_bn(64, 32)
        self.residual_6 = residual_block(32, 32)
        self.senet_6 = SELayer(32, 32)
    ...
    def forward(self, x):
        ...
        "decoder-1"
        y1_1 = self.up_conv1(x4_3)
        cat1 = torch.cat([x3_2, y1_1], 1)
