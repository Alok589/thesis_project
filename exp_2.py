...
device = "cuda:5"
# test_set_size = 22560
# test_set_size = np.arange(6000, 12000)
...
def evaluate_2_image(idx, savePlot):
...
for idx in range(6000, 12000):
    ssim_val, psnr_val = evaluate_2_image(idx, savePlot=False)
...
pd.DataFrame({"psnr": result_array1, "ssim": result_array2}).to_csv(
    "/home/thesis_2/Res_Unet_csvfiles/result_02.csv"
)
